...
public class SurvivalStats : MonoBehaviour
{
    ...
    public float hungerDecreasaRate = 1;
    ...
    void Update()
    {
        ...
        if(hungerTimer >= 1.0f)
        {
            currentHunger = Mathf.Max(0, currentHunger - hungerDecreasaRate);
            hungerTimer = 0;
    ...
    public void EatFood(float amount)
    {
        ...
        currentHunger = Mathf.Min(currentHunger, currentHunger + amount);
    ...
    public void RepairSuit(float amount)
    {
        ...
        currentSuitDurability = Mathf.Min(currentSuitDurability, currentSuitDurability + amount);
